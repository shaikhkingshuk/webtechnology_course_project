...
<body>
	...
	<table style="width:100%" border = 5 cellspacing = 5 cellpadding = 20>
		...
		$i=1;
		$rows=mysqli_query($conn,"SELECT * FROM allproducts WHERE Email='$iimail'");
		?>
		<?php 
		foreach($rows as $row) : ?>
		<tr>
			...
			<td><form method="post" action="delel.php"><input type="submit" name="submit" value="Delete" class="btn btn-info" /></form></td>
		</tr>
	<?php endforeach; ?>
</table>
<footer>
